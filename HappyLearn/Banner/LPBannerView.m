...
{
    [[[self class] sharedInstance] hideWithDuration:animated ? kDefaultBannerAnimationDurationTime : 0.0f];
}
...
- (void)showMessage:(NSString *)message inView:(UIView *)view andBannerView:(LPBannerView *)bannerView
{
    ...
    [UIView animateWithDuration:kDefaultBannerAnimationDurationTime delay:0.0f options:UIViewAnimationOptionCurveEaseInOut animations: ^{
...
{
    [self hideWithDuration:kDefaultBannerAnimationDurationTime];
