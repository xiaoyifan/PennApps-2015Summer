...
@objc class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let item1 = RMParallaxItem(image: UIImage(named: "item1")!, text: "KEEP YOUR PRACTICE ON SCHEDULE")
        let item2 = RMParallaxItem(image: UIImage(named: "item2")!, text: "BETTER INTERACTION TO MAKE STUDY COOL")
        let item3 = RMParallaxItem(image: UIImage(named: "item4")!, text: "CONQUER THE CHALLENGES")
